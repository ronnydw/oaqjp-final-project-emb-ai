"""
Flask server for the emotion_detector aaplication
"""
...
def emo_detector():
    """
    input: text from user: textToAnalyze
    send to emotion_detector function
    return: response based on user text emotions
    """
